...
package com.yuaihen.policeinfo.ui.adapter;
...
/**
 * 导入的是app.Fragment 非FragmentPagerAdapter的v4包下fragment
 */
public abstract class MyFragmentPagerAdapter extends PagerAdapter {
    ...
    public MyFragmentPagerAdapter(androidx.fragment.app.FragmentManager fm) {
        mFragmentManager = fm;
    }
