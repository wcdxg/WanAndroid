...
import com.yuaihen.policeinfo.net.converter.MyGsonConverterFactory
import com.yuaihen.policeinfo.utils.AppUtil
import com.yuaihen.policeinfo.utils.UserUtil
            ...
            if (method.equals("POST", ignoreCase = true)) {
                ...
                when (body) {
                    is FormBody? -> {
                        ...
                        if (!request.url.toString().contains("getToken", true)) {
                            builder.add(Constants.TOKEN, UserUtil.getToken())
                        }
